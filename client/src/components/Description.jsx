...
const Description = (props) => {
  ...
  return (
    <Container>
      ...
      <Img src="http://localhost:3002/images/mpg.png" />
      <Img2 src="http://localhost:3002/images/gas.png" />
      <Mpg>{props.car[5] + ' MPG'}</Mpg>
      <Gas>{props.car[6]}</Gas>
      <Img3 src="http://localhost:3002/images/doors.png" />
      <Doors>{props.car[7] + ' doors'}</Doors>
      <Img4 src="http://localhost:3002/images/seats.png" />
      ...
      <B2>{props.car[10]}</B2>
      <a href='#popup1'><img href='#popup1' src="http://127.0.0.1:3002/images/q.png"></img></a>
      <F1>FEATURES</F1>
      <F2>{props.car[11]}</F2>
      <Img5 src="http://localhost:3002/images/features.png"></Img5>
      <E1>EXTRAS</E1>
      <E2>
        {`${props.car[12]} `}
        <div></div>
      ...
      <Popup href='#popup2'><img href='#popup2' src="http://localhost:3002/images/q.png"></img></Popup>
      <G1>GUIDELINES</G1>
      <G2>
        {`${props.car[13]} `}
        <div></div>
